...
Compared to the previous architectures, this concept offers superior electrical stability and controllability. The continuously regulated fuel-cell output enables smoother power delivery and reduces pressure fluctuations within the hydrogen system.

However, implementation of this architecture requires a continuously controllable power regulation stage capable of handling up to 200 W. A survey of commercially available solutions did not identify a suitable off-the-shelf component that met the system requirements. Consequently, implementation would require the design and validation of custom power electronics.

Although technically feasible, the development of custom power electronics was considered outside the scope of this graduation project. The required electronics design effort would introduce significant development risk and reduce the time available for experimental validation of the hydrogen system itself.
...
% \begin{itemize}
%     \item Expected development Time;
%     \item Expected development Cost;
...
The proposed architectures were evaluated using a weighted trade-off analysis. In addition to traditional performance metrics such as efficiency, safety, and reliability, implementation feasibility was included as a key criterion. The purpose of the SHARP-PS project was not only to identify an optimal system architecture, but also to realise and experimentally validate the selected architecture within the available project duration and technical scope.

Implementation feasibility therefore considers the availability of required components, the development effort required for integration, and the technical risks associated with developing custom hardware. Architectures requiring substantial electronics development were assigned lower scores for this criterion, as custom power electronics design fell outside the intended scope of the project.
...
\begin{table}[htp]
    ...
    \begin{tabular}{lcccc}
        ...
        \midrule
        Implementation Feasibility & 5               & 4                & 5                & 1                \\
        System Complexity          & 3               & 4                & 5                & 3                \\
...
The trade-off analysis shows that Architecture 3 provides the best technical performance in terms of power stability, controllability, and reliability. However, achieving this performance would require the development of custom power electronics capable of continuously regulating fuel-cell power output at the required power levels.

A preliminary investigation was conducted into commercially available current-limiting and power-regulation solutions. No suitable off-the-shelf solution was identified. Implementing Architecture 3 would therefore require substantial electronics development, introducing significant project risk and extending the scope beyond that of the present graduation project.

Architecture 2 provides lower control performance but can be realised using commercially available components and straightforward control logic. This architecture enables the primary project objective—experimental validation of the hydrogen power generation and feed system—to be achieved within the available time, resources, and expertise.

For this reason, Architecture 2 was selected as the baseline architecture for detailed design and testing.
