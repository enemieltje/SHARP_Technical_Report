...
\begin{itemize}
      ...
      \item The system shall have a power density comparable to UAVs %(covered by wren)
\end{itemize}

These are translated to system requirements in a structured manner. Each requirement will adhere to the following structure:
...
\begin{itemize}
      ...
      \item The system should be able to operate at speeds up to 21 m/s
            ...
            % \item Test results will be recorded and presented in a research report in accordance with Elling \& Andeweg (not this system)
            % \item The research report shall answer the following research question: `\dots' (not this system)
\end{itemize}
