...
\tikzset{
    quickrelease/.pic={
            ...
            \draw [thick] (-0.6,-0.3) -- (-0.2,0) -- (-0.6, 0.3);
            \draw [thick] (0.6,-0.3) -- (0.2,0) -- (0.6, 0.3);
            \node [draw, thick, circle, fill=white] at (-0.5,0) {};
            \node [draw, thick, circle, fill=white] at (0.5,0) {};
...
% Pressure Regulator
\tikzset{
    pressure regulator/.pic = {
            % \draw[help lines] (\tikzlastnode.center) ++(-1, -1) grid ++(2,2);
            \node[draw, thick, fill=white, minimum width=1cm, minimum height=1cm] (box) {};

            \draw[thick, densely dashed] (0.5,0) -- +(0.25,0.25) -- +(0.25,1) -- +(-0.75,1) -- +(-0.75,0.5);
            % \draw[thick, fill=white] (\tikzlastnode.south west) -- +(1,0) -- +(1,1) -- +(0,1) -- +(0,0);
            \draw[->, thick, >=latex] (-0.5,0) -- (0.5,0);
            \draw[rotate=-90, thick, line join=bevel] (0.5,-0.5)
            -- +(0,0.25)
            -- +(0.05,0.5) -- +(0.15,0)
            -- +(0.25,0.5) -- +(0.35,0)
            -- +(0.45,0.5) -- +(0.55,0) -- +(0.6,0.25);
            \draw[->, thick, >=latex] (-0.5,-0.5) ++(-0.25, -0.175) -- +(1,-0.25);
            \coordinate (-in) at (-1,0);
            \coordinate (-out) at (1,0);
        }
}
...
\tikzset{
    filter/.pic = {
            \node[rotate=45, draw, thick, fill=white, minimum width=1cm, minimum height=1cm] (box) {};
            \coordinate (-in) at (box.north west);
            \coordinate (-out) at (box.south east);
        }
}
